...
//                     <div>
//                       <h3 className="text-[20 px] leading-6 font-normal text-[#252525]">
//                         {item.name}
//                       </h3>
...
//                         <button className="flex h-full w-[28px] items-center justify-center text-[#252525B8]">
//                           −
//                         </button>
//                         <span className="flex-1 text-center text-[14px] text-[#252525]">
//                           {item.qty}
//                         </span>
//                         <button className="flex h-full w-[28px] items-center justify-center text-[#252525B8]">
//                           +
...
//                   <button className="flex h-8 w-8 items-center justify-center border border-[#25252526] text-[#252525CC]">
//                     ‹
//                   </button>
//                   <button className="flex h-8 w-8 items-center justify-center border border-[#25252526] text-[#252525CC]">
//                     ›
...
//                     <h4 className="mt-3 text-[16px] leading-5 text-[#252525]">
//                       {item.name}
//                     </h4>
...
//               <span className="text-[16px] tobia-normal md:text-[20px] text-[#252525]">
//                 PKR 4,999
//               </span>
//             </div>

//             <div className="space-y-3">
//               <button className="flex h-[48px] w-full items-center justify-center bg-[#252525] text-[15px] text-white transition-opacity duration-300 hover:opacity-90">
//                 Proceed to checkout
//               </button>
