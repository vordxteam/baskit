...
const basketSizes = [
  { id: 'small',  label: 'Small',  image: '/images/small-basket.png'  },
  { id: 'medium', label: 'Medium', image: '/images/medium-basket.png' },
  { id: 'large',  label: 'Large',  image: '/images/large-baskit.png'  },
]
...
export default function BasketSizeSection({ selected, onSelect, onBack, onContinue }: Props) {
  return (
    <section id="basket-size" className="scroll-mt-24">
      <h2 className="text-[28px] sm:text-[32px] tobia-normal text-[#252525] mb-10">
        Choose your Baskit size
      </h2>
