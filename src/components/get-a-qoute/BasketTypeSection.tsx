...
const basketTypes = [
  { id: 'square', label: 'Square Basket', image: '/images/square-basket.png' },
  { id: 'round',  label: 'Round Basket',  image: '/images/round-basket.png'  },
  { id: 'box',    label: 'Box Basket',    image: '/images/box-basket.png'    },
]
